@component('mail::message')
    @if (isset($logoCid) && $logoCid)
        <div style="text-align: center; margin-bottom: 20px;">
            <img src="{{ $logoCid }}" alt="Logo Entreprise" style="width: 100px;">
        </div>
    @endif

    # Bonjour {{ $entretien->candidature->candidat->nom_utilisateur }},

    Votre entretien a été planifié avec succès pour l’offre
    **{{ $entretien->candidature->offre->titre_offre ?? 'Non spécifiée' }}**.
